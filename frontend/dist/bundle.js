...
;// CONCATENATED MODULE: ./node_modules/websocket-ts/dist/esm/src/websocket_event.js
/**
...
;// CONCATENATED MODULE: ./node_modules/websocket-ts/dist/esm/src/websocket.js
...
;// CONCATENATED MODULE: ./node_modules/websocket-ts/dist/esm/src/websocket_builder.js
...
;// CONCATENATED MODULE: ./node_modules/websocket-ts/dist/esm/src/backoff/constantbackoff.js
/**
...
var Player = /** @class */ (function () {
    ...
    Player.prototype.generateUID = function () {
    ...
    Player.prototype.getReplicateMessage = function () {
...
//# sourceMappingURL=data:application/json;base64,
...
var Canvas = function () {
    ...
    var websocket = new WebsocketBuilder("ws://127.0.0.1:8080/ws")
        .withBackoff(new ConstantBackoff(10 * 1000))
        .build();
    var controlledPlayer = new player(Math.floor(Math.random() * 101), Math.floor(Math.random() * 101));
    (0,react.useEffect)(function () {
        ...
        var draw = function () {
            ...
            if (controlledPlayer) {
                ...
                if (controlledPlayer.isMoving() && websocket && websocket.readyState === 1) {
                    var replicatePlayerMessage = controlledPlayer.getReplicateMessage();
        ...
        websocket.addEventListener(WebsocketEvent.open, function () {
        ...
        websocket.addEventListener(WebsocketEvent.close, function (websocket, event) {
            console.log("WebSocket connection closed with code:", event.code);
            console.log("WebSocket connection closed with reason:", event.reason);
        });
        websocket.addEventListener(WebsocketEvent.error, function (websocket, event) {
            console.error("WebSocket error:", event);
        });
        websocket.addEventListener(WebsocketEvent.message, function (websocket, event) {
            var message = JSON.parse(event.data);
            var uid = message.uid, x = message.x, y = message.y;
            if (!playersMap.has(uid)) {
                var newPlayer = new player(x, y);
                newPlayer.setUID(uid);
                playersMap.set(uid, newPlayer);
                if (websocket && websocket.readyState === 1) {
                    var replicatePlayerMessage = newPlayer.getReplicateMessage();
                    websocket.send(JSON.stringify(replicatePlayerMessage));
                }
                return;
            }
            var updatedPlayer = playersMap.get(uid);
            if (!updatedPlayer) {
                return;
            }
...
//# sourceMappingURL=data:application/json;base64,
